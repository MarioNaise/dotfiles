...
hl.bind(mainMod .. " + CTRL + SPACE", hl.dsp.exec_cmd("pkill wofi-emoji || wofi-emoji"))
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("pkill waybar || waybar"))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(terminal))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("firefox-devedition"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("firefox-devedition --private-window"))
...
hl.bind(mainMod .. " + CONTROL + ALT + left", hl.dsp.window.move({ monitor = "l"}))
hl.bind(mainMod .. " + CONTROL + ALT + right", hl.dsp.window.move({ monitor = "r"}))
